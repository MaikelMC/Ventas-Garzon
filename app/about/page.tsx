      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {[
              { title: 'Mayorista y Minorista', description: 'Compras al por mayor y detalle con precios competitivos.', icon: Store, color: 'from-blue-500 to-blue-600' },
              { title: 'Recoge en Tienda', description: 'Reserva online y recoge cuando te convenga. Sin esperas.', icon: ShoppingBag, color: 'from-teal-500 to-teal-600' },
              { title: 'Atención local', description: 'Soporte cercano con una experiencia de compra segura.', icon: Headphones, color: 'from-primary-500 to-primary-600' },
            ].map((item) => (
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center ml-[60px]">
            <Link href="/products" className="inline-flex items-center gap-2 bg-gradient-to-r from-primary-500 to-primary-600 text-white px-6 py-3 rounded-full font-bold hover:shadow-glow hover:from-primary-600 hover:to-primary-700 transition-all duration-300">
              Ver productos <ArrowRight size={18} />
            </Link>
            <Link href="/faq" className="inline-flex items-center gap-2 border-2 border-primary-500 dark:border-primary-400 text-primary-600 dark:text-primary-400 px-6 py-3 rounded-full font-bold hover:bg-primary-50 dark:hover:bg-primary-900/20 transition-all duration-300">
