...
const fadeInVariants = { hidden: { opacity: 0 }, visible: { opacity: 1, transition: { duration: 0.6 } } };
    ...
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center">
          <SlideUp>
            <div className="space-y-4 md:space-y-6">
              ...
              >
                Aseo, alimentos y productos esenciales con estilo fresco e inspirador. Compra con seguridad y recibe tu pedido rápido.
              </motion.p>
              <motion.div
          ...
          >
            <div className="w-full max-w-xs mx-auto md:max-w-none aspect-square rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden border-2 border-primary-200 dark:border-primary-800 bg-white dark:bg-surface-800 shadow-2xl dark:shadow-primary-500/10">
              <img src="/logo2.jpg" alt="Logo Ventas Garzón" className="w-full h-full object-cover" />
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-20 bg-surface-50 dark:bg-surface-900 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              { icon: Store, title: 'Recoge en Tienda', description: 'Reserva online y recoge cuando quieras', color: 'from-primary-500 to-primary-600' },
              { icon: Shield, title: 'Pago Seguro', description: 'Múltiples formas de pago seguras', color: 'from-secondary-500 to-secondary-600' },
              { icon: BadgeCheck, title: 'Calidad Garantizada', description: 'Productos de marca y garantía', color: 'from-emerald-500 to-emerald-600' },
            ].map((feature, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              <Link href="/products?category=aseo"
                className="inline-flex items-center gap-2 bg-white text-primary-600 px-5 md:px-6 py-2.5 md:py-3 rounded-full font-bold text-sm md:text-base hover:shadow-lg transition-all duration-300 relative z-10"
              >
            ...
            >
              ...
              <Link href="/products?category=alimentos"
                className="inline-flex items-center gap-2 bg-white text-secondary-600 px-5 md:px-6 py-2.5 md:py-3 rounded-full font-bold text-sm md:text-base hover:shadow-lg transition-all duration-300 relative z-10"
              >
                Ver Oferta <ArrowRight size={18} />
              </Link>
            </motion.div>
