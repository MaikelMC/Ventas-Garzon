...
const faqs = [
  { question: '¿Cómo realizo un pedido?', answer: 'Busca el producto que deseas, agrégalo al carrito y completa tus datos en el formulario de pago. Recibirás una confirmación por correo electrónico una vez que el pedido esté registrado.', category: 'orders' },
    ...
    <div className="min-h-screen pt-20 pb-16 bg-surface-dim dark:bg-surface-950">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mb-6">
          ...
          />
          {search && (
            <button onClick={() => setSearch('')} aria-label="Limpiar búsqueda" className="absolute right-4 top-1/2 -translate-y-1/2 text-xs text-ink-muted hover:text-ink">Limpiar</button>
          )}
        </div>
        ...
        <div className="mt-12 bg-primary-500 rounded-2xl p-6 text-center">
          ...
          <a
            href="mailto:info@ventasgarzon.com"
