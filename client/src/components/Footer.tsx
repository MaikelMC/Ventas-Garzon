        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              <li>
                <Link to="/products" className="hover:text-white hover:pl-1 transition-all duration-300 flex items-center gap-2">
                  <span className="w-1 h-1 bg-primary-500 rounded-full" />
                  Productos
                </Link>
              </li>
              <li>
                <Link to="/about" className="hover:text-white hover:pl-1 transition-all duration-300 flex items-center gap-2">
                  <span className="w-1 h-1 bg-primary-500 rounded-full" />
                  Acerca de
                </Link>
              </li>
              <li>
                <Link to="/faq" className="hover:text-white hover:pl-1 transition-all duration-300 flex items-center gap-2">
                  <span className="w-1 h-1 bg-primary-500 rounded-full" />
                  FAQ
                </Link>
              </li>
